...
setwd("/home/arw/scripts_R/")
dir.entrada <- ("/home/arw/scripts_R/datos_entrada/")
mapa <- readOGR(dsn=path.expand("/home/arw/shape"),layer="ESA_CA_wgs84")
mapa2 <- readOGR(dsn=path.expand("/home/arw/shape"),layer="TM_WORLD_BORDERS-0.3")

#Declara los días a usar
...
raw_acum<-raster("/home/arw/scripts_R/datos_entrada/acum_general_08.tif")
desv<-raster("/home/arw/scripts_R/desv/08.tif")

chirps_prom<-raster("/home/arw/scripts_R/CHIRPS_PROMEDIO/CHIRPS_08_PROM.tif")
q33_raw<-raster("/home/arw/scripts_R/climatologia_chirps_1981_2010/08_q33_1981_2010.tif")
q33<-crop(q33_raw,area_efectiva)
q66_raw<-raster("/home/arw/scripts_R/climatologia_chirps_1981_2010/08_q66_1981_2010.tif")
q66<-crop(q66_raw,area_efectiva)
prom_raw<-raster("/home/arw/scripts_R/climatologia_chirps_1981_2010/08_promedio_1981_2010.tif")
...
rf<-writeRaster(escenarios, filename="/home/arw/scripts_R/resultados/escenario.tif", overwrite=TRUE)

anomalia<-resample(pronostico_ajustado,prom)-prom
anomalia[anomalia <= -500]<-(-500)
anomalia[anomalia >= 500]<-500

rf<-writeRaster(anomalia, filename="/home/arw/scripts_R/resultados/anomalia.tif", overwrite=TRUE)
...
rf<-writeRaster(anomalia_porcentual, filename="/home/arw/scripts_R/resultados/anomalia_porcentual.tif", overwrite=TRUE)
...
write.table(mat_Lluvia_mensual_cruda, file="/home/arw/scripts_R/resultados/lluvia_mensual_raw.csv",row.names = FALSE, col.names = FALSE, sep =",")
write.table(mat_Lluvia_mensual_ajustada, file="/home/arw/scripts_R/resultados/lluvia_mensual_ajustada.csv",row.names = FALSE, col.names = FALSE, sep =",")
write.table(mat_desviacion_promedio, file="/home/arw/scripts_R/resultados/desviacion_promedio.csv",row.names = FALSE, col.names = FALSE, sep =",")

#------------------------------------------------------------------------------------------------------------
#Escribe los valores de modelo ajustado en un raster
rf<-writeRaster(raw_acum, filename="/home/arw/scripts_R/resultados/raw_pronostico.tif", overwrite=TRUE)
rf<-writeRaster(acum_ajustada_final, filename="/home/arw/scripts_R/resultados/pronostico_ajustado.tif", overwrite=TRUE)
rf<-writeRaster(anom, filename="/home/arw/scripts_R/resultados/anomalias_precipitacion.tif", overwrite=TRUE)
...
rf<-writeRaster(acumulado_cumulos, filename="/home/arw/scripts_R/resultados/precipitacion_general_cumulos.tif", overwrite=TRUE)
rf<-writeRaster(acumulado_microfisica, filename="/home/arw/scripts_R/resultados/precipitacion_general_microfisica.tif", overwrite=TRUE)
...
rf<-writeRaster(temperatura_promedio_mensual, filename="/home/arw/scripts_R/resultados/temperatura_promedio_mensual.tif", overwrite=TRUE)
#------------------------------------------------------------------------------------------------------------

#------------------------------------------------------------------------------------------------------------
#Carga los rasters de temperatura mínima
...
rf<-writeRaster(temperatura_minima_promedio_mensual, filename="/home/arw/scripts_R/resultados/temperatura_minima_promedio_mensual.tif", overwrite=TRUE)
...
rf<-writeRaster(temperatura_minima_absoluta, filename="/home/arw/scripts_R/resultados/temperatura_minima_absoluta.tif", overwrite=TRUE)
...
rf<-writeRaster(temperatura_minima_maxima_absoluta, filename="/home/arw/scripts_R/resultados/temperatura_minima_maxima_absoluta.tif", overwrite=TRUE)

#------------------------------------------------------------------------------------------------------------

#------------------------------------------------------------------------------------------------------------
#Carga los rasters de temperatura máxima
...
rf<-writeRaster(temperatura_maxima_promedio_mensual, filename="/home/arw/scripts_R/resultados/temperatura_maxima_promedio_mensual.tif", overwrite=TRUE)
...
rf<-writeRaster(temperatura_maxima_absoluta, filename="/home/arw/scripts_R/resultados/temperatura_maxima_absoluta.tif", overwrite=TRUE)

#Temperatura minima máxima absoluta
...
rf<-writeRaster(temperatura_maxima_minima_absoluta, filename="/home/arw/scripts_R/resultados/temperatura_maxima_minima_absoluta.tif", overwrite=TRUE)

#------------------------------------------------------------------------------------------------------------


##############################################################################################################
#Genera imagenes de pronóstico regional
##############################################################################################################
...
jpeg("/home/arw/scripts_R/resultados/wrf.jpg", width = 2000, height = 1400)
plot(acum_resampled,main="Precipitacion en mm para el mes de agosto de 2020 \n WRF Clima - CI 15 febrero 2020", xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
...
jpeg("/home/arw/scripts_R/resultados/wrf_ajustado.jpg", width = 2000, height = 1400)
plot(pronostico_ajustado,main="Precipitacion en mm para el mes de agosto de 2020 \n WRF Clima - CI 15 febrero 2020", xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     col=paleta.colores(12),alpha=TRUE,interpolate=FALSE,ylab="Latitud",xlab="Longitud",legend=TRUE)
plot(mapa,add = TRUE, xlim=c(-90.2,-87.6),ylim=c(12.9,14.7))
dev.off()

#Exporta como imagen  ------------ Fisica de cumulos
jpeg("/home/arw/scripts_R/resultados/wrf_cumulos.jpg", width = 2000, height = 1400)
plot(acumulado_cumulos,main="Precipitacion en mm para el mes de agosto de 2020 \n WRF Clima CI 15 febrero 2020 - Fisica de cumulos", xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     col=paleta.colores(14),alpha=TRUE,interpolate=FALSE,ylab="Latitud",xlab="Longitud",legend=TRUE)
plot(mapa,add = TRUE, xlim=c(-90.2,-87.6),ylim=c(12.9,14.7))
dev.off()

#Exporta como imagen  ------------ Microfisica
jpeg("/home/arw/scripts_R/resultados/wrf_microfisica.jpg", width = 2000, height = 1400)
plot(acumulado_microfisica,main="Precipitacion en mm para el mes de agosto de 2020 \n WRF Clima CI 15 febrero 2020- Microfisica", xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     col=paleta.colores(14),alpha=TRUE,interpolate=FALSE,ylab="Latitud",xlab="Longitud",legend=TRUE)
plot(mapa,add = TRUE, xlim=c(-90.2,-87.6),ylim=c(12.9,14.7))
dev.off()
...
##############################################################################################################
png("/home/arw/scripts_R/resultados/escenario.png", pointsize=13, res = 150, width = 2000, height = 1400)
plot(escenarios, col=paleta(3),legend=FALSE,ylim=c(6.8,23.3),xlim(-93,-68),breaks=c(-1,-0.9999,0.9999,1),
     main="Escenarios WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
legend("topright",legend = c("A","N","B"),fill = c("#04B404","#F3F781","#B18904"))
plot(mapa2,add=TRUE,xlim=c(-95.8,-68.1145),ylim=c(6.8,23.3))
dev.off()

png("/home/arw/scripts_R/resultados/anomalia.png", pointsize=13, res = 150, width = 2000, height = 1400)
plot(anomalia, col=paleta.anomalias(20),legend=TRUE,ylim=c(6.8,23.3),xlim(264.2-360,291.8855-360),
     main="Anomalía (mm) WRF-Clima3 vs CHIRPS agosto de 2020 - CI 15 febrero 2020",breaks = seq(from = -500, to = 500, by = 50))
plot(mapa2,add=TRUE,xlim=c(-95.8,-68.1145),ylim=c(6.8,23.3))
dev.off()

png("/home/arw/scripts_R/resultados/anomalia_porcentual.png", pointsize=13, res = 150, width = 2000, height = 1400)
plot(anomalia_porcentual, col=paleta.errores(12),legend=TRUE,ylim=c(6.8,23.3),xlim(264.2-360,291.8855-360),
     main="Anomalía porcentual WRF-Clima3 vs CHIRPS agosto de 2020 - CI 15 febrero 2020",breaks = seq(from = -300, to = 300, by = 50))
plot(mapa2,add=TRUE,xlim=c(-95.8,-68.1145),ylim=c(6.8,23.3))
dev.off()
...
##############################################################################################################
png("/home/arw/scripts_R/resultados/escenario_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
...
png("/home/arw/scripts_R/resultados/anomalia_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(anomalia, col=paleta.errores(20),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Anomalía (mm) WRF-Clima3 vs CHIRPS agosto de 2020 - CI 15 febrero 2020",breaks = seq(from = -500, to = 500, by = 50))
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/anomalia_porcentual_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
...
png("/home/arw/scripts_R/resultados/temperatura_promedio_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_promedio_mensual, col=paleta.temperaturas(14),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura promedio °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/temperatura_maxima_promedio_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_maxima_promedio_mensual, col=paleta.temperaturas(14),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura máxima promedio °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/temperatura_minima_promedio_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_minima_promedio_mensual, col=paleta.temperaturas(14),xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura mínima promedio °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/temperatura_maxima_absoluta_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_maxima_absoluta, col=paleta.temperaturas(14),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura máxima absoluta °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/temperatura_minima_absoluta_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_minima_absoluta, col=paleta.temperaturas(14),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura mínima absoluta °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/temperatura_minima_maxima_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_minima_maxima_absoluta, col=paleta.temperaturas(14),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura mínima máxima absoluta °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()

png("/home/arw/scripts_R/resultados/temperatura_máxima_minima_esa.png", pointsize=13, res = 150, width = 1800, height = 1350)
plot(temperatura_maxima_minima_absoluta, col=paleta.temperaturas(14),legend=TRUE,xlim=c(-90.2,-87.6),ylim=c(12.9,14.7),
     main="Temperatura máxima mínima absoluta °C WRF-Clima3 agosto de 2020 - CI 15 febrero 2020")
plot(mapa,add=TRUE,xlim=c(-90.2,-87.7),ylim=c(13.1,14.7))
dev.off()
