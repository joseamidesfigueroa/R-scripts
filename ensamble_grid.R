  ...
  #------------------------------------------------------------------------------ 48 horas
  #Probabilidad de más de 10mm
  dummy1<-Con((lluvia_48_A>=10),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=10),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=10),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=10),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=10),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=10),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=10),cte+dummy,0+dummy)
  prob_10mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 20mm
  dummy1<-Con((lluvia_48_A>=20),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=20),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=20),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=20),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=20),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=20),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=20),cte+dummy,0+dummy)
  prob_20mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 30mm
  dummy1<-Con((lluvia_48_A>=30),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=30),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=30),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=30),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=30),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=30),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=30),cte+dummy,0+dummy)
  prob_30mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 40mm
  dummy1<-Con((lluvia_48_A>=40),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=40),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=40),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=40),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=40),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=40),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=40),cte+dummy,0+dummy)
  prob_40mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 50mm
  dummy1<-Con((lluvia_48_A>=50),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=50),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=50),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=50),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=50),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=50),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=50),cte+dummy,0+dummy)
  prob_50mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 60mm
  dummy1<-Con((lluvia_48_A>=60),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=60),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=60),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=60),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=60),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=60),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=60),cte+dummy,0+dummy)
  prob_60mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 70mm
  dummy1<-Con((lluvia_48_A>=70),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=70),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=70),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=70),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=70),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=70),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=70),cte+dummy,0+dummy)
  prob_70mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 80mm
  dummy1<-Con((lluvia_48_A>=80),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=80),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=80),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=80),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=80),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=80),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=80),cte+dummy,0+dummy)
  prob_80mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 90mm
  dummy1<-Con((lluvia_48_A>=90),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=90),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=90),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=90),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=90),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=90),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=90),cte+dummy,0+dummy)
  prob_90mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 100mm
  dummy1<-Con((lluvia_48_A>=100),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=100),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=100),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=100),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=100),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=100),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=100),cte+dummy,0+dummy)
  prob_100mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 150mm
  dummy1<-Con((lluvia_48_A>=150),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=150),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=150),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=150),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=150),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=150),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=150),cte+dummy,0+dummy)
  prob_150mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 200mm
  dummy1<-Con((lluvia_48_A>=200),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=200),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=200),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=200),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=200),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=200),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=200),cte+dummy,0+dummy)
  prob_200mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 300mm
  dummy1<-Con((lluvia_48_A>=300),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=300),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=300),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=300),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=300),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=300),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=300),cte+dummy,0+dummy)
  prob_300mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  
  #*******************************************************************************************************
  #Probabilidad de más de 500mm
  dummy1<-Con((lluvia_48_A>=500),cte+dummy,0+dummy)
  dummy2<-Con((lluvia_48_B>=500),cte+dummy,0+dummy)
  dummy3<-Con((lluvia_48_C>=500),cte+dummy,0+dummy)
  dummy4<-Con((lluvia_48_D>=500),cte+dummy,0+dummy)
  dummy5<-Con((lluvia_48_E>=500),cte+dummy,0+dummy)
  dummy6<-Con((lluvia_48_F>=500),cte+dummy,0+dummy)
  dummy7<-Con((lluvia_48_G>=500),cte+dummy,0+dummy)
  prob_500mm_48h<-sum(dummy1,dummy2,dummy3,dummy4,dummy5,dummy6,dummy7)
  #*******************************************************************************************************
  ##############################################################################################################
  ##############################################################################################################
